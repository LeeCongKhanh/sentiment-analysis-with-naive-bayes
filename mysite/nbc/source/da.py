...
root_path = settings.PROJECT_ROOT+"/nbc/source/"
class ProcessData:
    def __init__(self):
        self.stopwords = [line.rstrip('\n') for line in open(root_path+"stopwords.txt",'rt')]
...
class NaiveBayes:
    def __init__(self, file_data_train):
        ...
        # print(self.data['sentence'].values)
    ...
    def predict(self, sentence):
        ...
        if not os.path.exists(root_path+"positive_model.csv"):
            self.training()
        if not os.path.exists(root_path+"negative_model.csv"):
            self.training()
        if not os.path.exists(root_path+"neutral_model.csv"):
            self.training()
        
        cal_P_W_C_Pos = pd.read_csv(root_path+"positive_model.csv")
        cal_P_W_C_Neg = pd.read_csv(root_path+"negative_model.csv")
        cal_P_W_C_Neu = pd.read_csv(root_path+"neutral_model.csv")
    ...
    def cal_P_W_C(self, smooth, class_sentiment):
        ...
        path = root_path + class_sentiment+"_model.csv"
